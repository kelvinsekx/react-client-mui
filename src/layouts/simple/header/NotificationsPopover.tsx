...
const NotificationsPopover = () => {
  ...
  return (
    <>
      ...
      >
        <Stack display="flex" direction="row" justifyContent="space-between" alignItems="center" margin={1}>
        ...
        <List sx={{ width: '100%', maxWidth: 360, maxHeight: 300, bgcolor: 'background.paper', overflow: "auto" }}>
          {...Array.from({
            length: 25
          }).map((_, idx) => (
            <>
