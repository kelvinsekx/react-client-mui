            ...
            >
                <Grid item xs={12} md={6} order={{ xs: 2, md: 1 }}>
                    ...
                    <Typography variant="h6" paragraph sx={{ mb: 2 }}>
                        Master grammar, spelling, and syntax in the language(s)
                        you’re learning through direct feedback on your writing
                    ...
                    >
                        <Typography
                            variant="body1"
                            sx={{ textTransform: "none", pr: { xs: 0, md: 1 } }}
                        >
                            Start learning
                        </Typography>
                        <Typography
            ...
            <BootstrapContainer>
                ...
                >
                    ...
                    >
                        <Typography
                            variant="h4"
                            sx={{ fontWeight: "bold", mb: 1, maxWidth: 450 }}
                        >
                            Getting corrections on your writing is really easy
                        </Typography>
                        <Typography variant="h6" paragraph>
                            Once you're done writing in your studying language,
                            we will automatically match it with native speakers.
                        </Typography>
                    </Grid>
                    <Grid
                        item
        ...
        <BootstrapContainer>
            <Grid container justifyContent="center" alignItems="center">
                <Grid item xs={12} md={8} sx={{ pr: { xs: 0, md: 10 } }}>
                    ...
                    <Typography variant="body1" paragraph>
                        Whether you’re fluent or just starting out, we’d be
                        thrilled to have you join the LangCorrect community.
                        We’re all learners and we understand that innd
                        confidence in a new language, it’s important to make
                        mistakes. LangCorrect’s wonderful users are ready to
                        help you, provide support, and answer your burning
